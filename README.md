...
测试覆盖文字表解析、signed/unsigned hash、旧版本兼容降级、真实样例XLSX的drawing提取、图标平移容忍、错列自动归位、同名武器类型纠正和特殊二号位普通/强化perk选择。当前完整真实Manifest回归基线为：4120个drawing、3221个perk图标位置、184/184个唯一perk图标识别成功；6326条组合审计记录经DIM语义去重后输出6210条Wishlist规则。
